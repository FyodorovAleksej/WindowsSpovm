...
#define BUFFSIZE 256
#define FILENAME "E:\\Lab4_Threads\\threads.bin"
#define TIMEFILENAME "E:\\Lab4_Threads\\timer.bin"
...
int main(int argc, char *argv[])
{
	...
	if (!hSemaphore)
	{
		...
		//CloseHandle(hSemaphore);                            // destroying semaphore
		return -1;
	}
	//WaitForSingleObject(hSemaphore, INFINITE);				//catch semaphore
	//ReleaseSemaphore(hSemaphore, 1, NULL);

	int out;
	out = atoi(argv[2]);									//time for out all threads

	CreateProcess(L"E:\\Lab4_Threads\\Timer\\Debug\\Timer.exe", NULL, FALSE, NULL, NULL, CREATE_NEW_CONSOLE, NULL, NULL, &si, &pi);
	CreateProcess(L"E:\\Lab4_Threads\\ActionThreads\\Debug\\ActionThreads.exe", NULL, FALSE, NULL, NULL, CREATE_NEW_CONSOLE, NULL, NULL, &si, &pi);
	CreateProcess(L"E:\\Lab4_Threads\\Cheker\\Debug\\Cheker.exe", NULL, FALSE, NULL, NULL, CREATE_NEW_CONSOLE, NULL, NULL, &si, &pi);
